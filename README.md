...
- в списке статей не уходит запрос на следующию страницу, так же в старом дизайне внизу белая полоска
...
- урок 136 11 мин: надо добавить функции со стандартизированными стилями (отспупами и тд) (по факту заменить VStack и HStack)
- добавить в jsonSettings настройку для коллапса сайдбара
- TODO
- сортировка  статей по возрастанию/убыванию не работает, хотя запрос уходит корректно
- для применения стилей нового/старого дизайна нужно обновлять страницу
- унифицировать паддинги
