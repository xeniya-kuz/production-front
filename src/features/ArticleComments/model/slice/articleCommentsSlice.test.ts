...
describe('articleCommentsSlice', () => {
    ...
    const commentsAdapter = jest.mocked(
    ...
    test('fetchCommentsByArticleId pending', async () => {
        ...
        expect(
            articleCommentsReducer(
                ...
                // передавать action creator без вызова можно только если reducer не использует ничего кроме action.type
        ...
        expect(
            articleCommentsReducer(
                ...
                fetchCommentsByArticleId.rejected(
                    null,
                    fetchCommentsByArticleId.rejected.type,
                    '',
                    'error',
                ),
            ),
        ...
        expect(
            articleCommentsReducer(
                ...
                addArticleComment.rejected(
                    null,
                    addArticleComment.rejected.type,
                    '',
                    'error',
                ),
            ),
