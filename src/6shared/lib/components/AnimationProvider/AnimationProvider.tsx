import { createContext, type JSX, useContext, useEffect, useMemo, useRef, useState, type ReactNode } from 'react'
...
export const useAnimationLibs = (): Required<AnimationContextProps> => useContext(AnimationContext) as Required<AnimationContextProps>

export const AnimationPropvider = ({ children }: { children: ReactNode }): JSX.Element => {
