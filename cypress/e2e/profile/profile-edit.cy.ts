...
describe('User visits profile page', () => {
  ...
  it('And edits it', () => {
    ...
    cy.getByTestId(DATA_TEST_ID.profileCardFirstname).should('have.value', newName)
    cy.getByTestId(DATA_TEST_ID.profileCardLastname).should('have.value', newLastname)
  })
})
